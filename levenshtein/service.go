...
// Service provides an interface to determining string similarity using
...
// Start starts the distance service
func Start() {
...
func makeDistanceEndpoint(service Service) endpoint.Endpoint {
